...
# dial = Dial(dial_diameter, DialStyle.ARABIC_NUMBERS, font="Swonderful Bold", font_scale=0.9,
...
# hands = Hands(style=HandStyle.ART_DECO, minute_fixing="circle", minute_fixing_d1=motion_works.get_minute_hand_square_size(), hourfixing_d=motion_works.get_hour_hand_hole_d(),
