...
dial = Dial(180, DialStyle.ROMAN_NUMERALS, romain_numerals_style=RomanNumeralStyle.SIMPLE_ROUNDED, raised_detail=False, outer_edge_style=DialStyle.CONCENTRIC_CIRCLES,
            dial_width=25)
dial_diameter=180
...
show_object(dial.get_dial().rotate((0,0,0), (0,1,0), 180), options={"color": "white"}, name="Dial")
show_object(dial.get_all_detail().rotate((0,0,0), (0,1,0), 180), options={"color": Colour.BLACK}, name="Detail")

motion_works = MotionWorks(compensate_loose_arbour=True, compact=True, bearing=get_bearing_info(3), cannon_pinion_friction_ring=True)
...
hands.show_hands(show_object=show_object, hand_colours=[Colour.BLACK, Colour.BLACK, Colour.RED])
