...
if second_hand:
    ...
    pinion_extensions = [0, 0, 1, 25, 0, 0]
...
if dial is None:
    if moon:
        ...
        dial = Dial(outside_d=dial_d, bottom_fixing=False, top_fixing=False, romain_numerals_style=RomanNumeralStyle.SIMPLE_SQUARE, style=DialStyle.ROMAN_NUMERALS,
                    outer_edge_style=DialStyle.DOTS, seconds_style=DialStyle.CONCENTRIC_CIRCLES, dial_width=dial_width, pillar_style=pillar_style, raised_detail=True,
