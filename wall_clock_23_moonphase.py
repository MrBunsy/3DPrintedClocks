...
plates = clock.SimpleClockPlates(train, motion_works,plate_thick=9, back_plate_thick=11, pendulum_sticks_out=pendulumSticksOut, name="Wall 23", gear_train_layout=clock.GearTrainLayout.VERTICAL_COMPACT,
