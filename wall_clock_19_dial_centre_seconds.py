...
train=GoingTrain(pendulum_period=1.5, fourth_wheel=False, escapement=escapement, max_weight_drop=1200, chain_at_back=False, powered_wheels=0, runtime_hours=30,
...
motionWorks = MotionWorks(extra_height=20, style=gearStyle, bearing=get_bearing_info(3), module=1, compensate_loose_arbor=False, compact=True, thick=1.8, pinion_thick=8)
...
plates = SimpleClockPlates(train, motionWorks, plate_thick=7, pendulum_sticks_out=pendulumSticksOut, name="clock 19",
                           gear_train_layout=GearTrainLayout.VERTICAL, back_plate_from_wall=40, pendulum_fixing=pendulumFixing, pendulum_at_front=False, centred_second_hand=True, chain_through_pillar_required=True,
