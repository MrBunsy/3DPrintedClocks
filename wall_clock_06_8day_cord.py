...
train.gen_gears(module_size=1, moduleReduction=0.875, thick=2, chainWheelThick=6, useNyloc=False, pinionThickMultiplier=4, style=gearStyle, chain_module_increase=1, chainWheelPinionThickMultiplier=2)#, chainModuleIncrease=1.1)
