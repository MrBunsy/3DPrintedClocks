...
train = GoingTrain(pendulum_period=pendulum_period, wheels=4, escapement=escapement, max_weight_drop=104*25.4/2, use_pulley=True, chain_at_back=False, chain_wheels=1, runtime_hours=8 * 24, support_second_hand=False)#, huygensMaintainingPower=True)
