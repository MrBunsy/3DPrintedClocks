...
plates = clock.SimpleClockPlates(train, motionWorks, plate_thick=8, pendulum_sticks_out=pendulumSticksOut, name="clk 17", gear_train_layout=clock.GearTrainLayout.VERTICAL, pendulum_at_front=False,
