...
Planned long ago, but finally settled on being a spring powered brocot escapement wall clock, so this is based on mantel_clock_31, but bigger
...
train.calculate_ratios(max_wheel_teeth=70, min_pinion_teeth=10, wheel_min_teeth=60, pinion_max_teeth=15, max_error=0.1, module_reduction=moduleReduction, loud=True)
...
dial = clock.Dial(outside_d=205, bottom_fixing=False, top_fixing=False, style=clock.DialStyle.LINES_ARC, dial_width=25)
plates = clock.RoundClockPlates(train, motionWorks, name="Wall 24", dial=dial, plate_thick=6, layer_thick=0.2, escapement_on_front=True, pendulum_sticks_out=20,
