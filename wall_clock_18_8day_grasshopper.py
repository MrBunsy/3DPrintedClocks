...
train.gen_gears(module_size=1, module_reduction=1.1, thick=2.4, chain_wheel_thick=5, useNyloc=False, style=gearStyle, pinion_thick_multiplier=2, chain_wheel_pinion_thick_multiplier=2, pendulum_fixing=pendulumFixing)
...
plates = clock.SimpleClockPlates(train, motionWorks, pendulum, plate_thick=10, pendulum_sticks_out=pendulumSticksOut, name="clk 18", style=clock.ClockPlateStyle.VERTICAL, pendulum_at_front=False,
...
hands = clock.Hands(style=clock.HandStyle.BREGUET, chunky=True, secondLength=25, minuteFixing="square", minuteFixing_d1=motionWorks.get_minute_hand_square_size(), hourfixing_d=motionWorks.get_hour_hand_hole_d(),
