...
train.gen_gears(module_size=1, module_reduction=1.1, thick=2.4, powered_wheel_thick=5, style=gearStyle, pinion_thick_multiplier=2, powered_wheel_pinion_thick_multiplier=2, pendulum_fixing=pendulumFixing)
