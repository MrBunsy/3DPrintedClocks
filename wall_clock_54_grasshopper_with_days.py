...
if days:
    ...
    days_complication = DayOfWeekComplication(module=0.65, style=gear_style, bevel_module=0.9, angle_deg=-45, extra_z_height=6,
                                              cylinder_length=11, shortened_days=True, text_on_plaques=True, geneva_scale=0.7 / 0.65)
