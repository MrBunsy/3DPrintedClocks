...
power = clock.CordBarrel(ratchet_thick=8, rod_metric_size=4, cord_thick=2, thick=14-0.5, style=gear_style, use_key=True, diameter=35, loose_on_rod=False, ratchet_has_external_pawl=True,
