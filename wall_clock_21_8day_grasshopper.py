...
train.gen_gears(module_size=1, module_reduction=1, thick=3, powered_wheel_thick=4, style=gearStyle, pinion_thick_multiplier=2,
                powered_wheel_pinion_thick_multiplier=2, pendulum_fixing=pendulumFixing, escapement_split=True)
...
plates = clock.SimpleClockPlates(train, motionWorks, plate_thick=10, pendulum_sticks_out=pendulumSticksOut, name="clk 21", gear_train_layout=clock.GearTrainLayout.VERTICAL, pendulum_at_front=False,
