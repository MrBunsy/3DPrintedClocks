...
pendulum = clock.Pendulum(bob_d=70, bob_thick=10, hand_avoider_inner_d=80)
...
hands = clock.Hands(style=clock.HandStyle.CUCKOO, second_length=40, minute_fixing="square",
