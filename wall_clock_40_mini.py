...
# plates = SimpleClockPlates(train, motion_works, pendulum, plate_thick=9, back_plate_thick=11, pendulum_sticks_out=pendulumSticksOut, name="Wall 23", gear_train_layout=GearTrainLayout.COMPACT,
...
assembly = Assembly(plates, name=clock_name, hands=hands, time_seconds=30, pendulum=pendulum, pulley=pulley)
...
#[Colour.ORANGE, Colour.ORANGE, Colour.GREEN, Colour.GREEN, Colour.GREEN, Colour.DARK_GREEN]
if not outputSTL:
