...
plates = clock.SimpleClockPlates(train, motionWorks, plate_thick=9, back_plate_thick=11, pendulum_sticks_out=pendulumSticksOut, name="Wall22 Tony", gear_train_layout=clock.GearTrainLayout.COMPACT,
