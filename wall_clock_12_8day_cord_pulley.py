...
hands = clock.Hands(style=clock.HandStyle.SIMPLE_ROUND,  minuteFixing="circle",  minuteFixing_d1=motionWorks.getMinuteHandSquareSize(), hourfixing_d=motionWorks.getHourHandHoleD(),
