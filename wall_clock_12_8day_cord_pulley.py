...
train = clock.GoingTrain(pendulum_period=2, fourth_wheel=False, escapement=escapement, max_weight_drop=1200, use_pulley=True, chain_at_back=False, powered_wheels=1, runtime_hours=7.25 * 24)#, huygensMaintainingPower=True)
...
motionWorks = clock.MotionWorks(extra_height=11-3, style=gearStyle, thick=3, compensate_loose_arbor=False, bearing=clock.get_bearing_info(3),
...
hands = clock.Hands(style=clock.HandStyle.BREGUET, minute_fixing="circle", minute_fixing_d1=motionWorks.get_minute_hand_square_size(), hourfixing_d=motionWorks.get_hour_hand_hole_d(),
                    length=dial.outside_d*0.45, thick=motionWorks.minute_hand_slot_height, outline=1, outline_same_as_body=False, second_hand_centred=True, chunky=True,
