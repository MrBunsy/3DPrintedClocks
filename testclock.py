...
train.gen_gears(module_size=1, module_reduction=0.875, thick=3, powered_wheel_thick=6, useNyloc=False)
...
hands = Hands(style="simple_rounded", minuteFixing="square", minuteFixing_d1=motionWorks.get_minute_hand_square_size(), hourfixing_d=motionWorks.get_hour_hand_hole_d(), length=100, thick=motionWorks.minute_hand_slot_height, outline=1, outlineSameAsBody=False)
