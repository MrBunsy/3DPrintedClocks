...
motion_works = MotionWorks(extra_height=motion_works_height, style=gear_style, thick=3, compensate_loose_arbor=True, compact=True, drives_complication=moon_complication,
