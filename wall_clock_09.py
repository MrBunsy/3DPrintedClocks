...
train = clock.GoingTrain(pendulum_period=2, fourth_wheel=False, escapement=escapement, max_weight_drop=1800, chain_at_back=False, powered_wheels=1, runtime_hours=180, max_chain_wheel_d=28)
...
train.gen_gears(module_size=1
                , module_reduction=0.875, thick=2, powered_wheel_thick=6, pinion_thick_multiplier=4, style=gearStyle, powered_wheel_module_increase=1, powered_wheel_pinion_thick_multiplier=2)#, chainModuleIncrease=1.1)
...
plates = clock.SimpleClockPlates(train, motionWorks, pendulum, plate_thick=8, pendulum_sticks_out=pendulumSticksOut, name="Wall 06", gear_train_layout=clock.GearTrainLayout.VERTICAL, motion_works_above=True, heavy=True)


hands = clock.Hands(style="simple_rounded", minute_fixing="square", minute_fixing_d1=motionWorks.get_minute_hand_square_size(), hourfixing_d=motionWorks.get_hour_hand_hole_d(), length=100, thick=motionWorks.minute_hand_slot_height, outline=1, outline_same_as_body=False, second_length=25)
...
assembly = clock.Assembly(plates, hands=hands, time_mins=0, time_seconds=30, pendulum=pendulum)
