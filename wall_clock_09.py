...
plates = clock.SimpleClockPlates(train, motionWorks, plate_thick=8, pendulum_sticks_out=pendulumSticksOut, name="Wall 06", gear_train_layout=clock.GearTrainLayout.VERTICAL, motion_works_above=True, heavy=True)
