...
train.gen_gears(module_size=1
                , module_reduction=0.875, thick=2, chain_wheel_thick=6, pinion_thick_multiplier=4, style=gearStyle, powered_wheel_module_increase=1, chain_wheel_pinion_thick_multiplier=2)#, chainModuleIncrease=1.1)
