...
big_escapement = clock.AnchorEscapement(60, diameter=132, drop=escapement.drop_deg, lift=escapement.lift_deg, anchor_teeth=9.5, style=clock.AnchorStyle.CURVED_MATCHING_WHEEL,
...
if chain:
    powered_wheel = clock.PocketChainWheel2(ratchet_thick=6, chain=clock.COUSINS_1_5MM_CHAIN, max_diameter=25)
max_weight_drop = 1000
if chain:
    max_weight_drop=1400
train = clock.GoingTrain(pendulum_period=1.0, wheels=3, escapement=big_escapement, max_weight_drop=max_weight_drop, use_pulley=not chain, chain_at_back=False, powered_wheels=1,
