...
train.gen_gears(module_size=1.6, module_reduction=0.875, thick=3, powered_wheel_thick=4, style=gearStyle, pinion_thick_multiplier=2, powered_wheel_pinion_thick_multiplier=2, escapement_split=clock.SplitArborType.WHEEL_OUT_FRONT)
...
plates = clock.SimpleClockPlates(train, motionWorks, plate_thick=6, pendulum_sticks_out=pendulumSticksOut, name="clk 14", gear_train_layout=clock.GearTrainLayout.VERTICAL, pendulum_at_front=False,
