...
arbor = Arbor(arbor_d=3, wheel=pairs[1].wheel, wheel_thick=5.4, pinion=pairs[0].pinion, pinion_thick=12, end_cap_thick=-1,style=GearStyle.FLOWER,
              distance_to_next_arbor=pairs[1].centre_distance, pinion_at_front=True, clockwise_from_pinion_side=True, pinion_type=PinionType.THIN_LANTERN, type=ArborType.WHEEL_AND_PINION)
