...
plates = clock.SimpleClockPlates(train, motionWorks, plate_thick=8, pendulum_sticks_out=pendulumSticksOut, name="Wall 05", gear_train_layout=clock.GearTrainLayout.ROUND, heavy=True)
