...
class CrownGearPair(GearBase):
    ...
    def __init__(self, module, gear_teeth, pinion_teeth, face_width,
        ...
        # Cone Angle of the Gear
        delta_gear = math.pi / 2  # np.arctan(aa_sin / (pinion_teeth / gear_teeth + aa_cos))

        # Cone Angle of the Pinion
        delta_pinion = 0.05 * math.pi / 2  # np.arctan(aa_sin / (gear_teeth / pinion_teeth + aa_cos))
