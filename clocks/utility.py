...
class BillOfMaterials:
    ...
    GENERIC_INSTRUCTIONS_INTRO = """
These instructions are autogenerated by the 3DPrintedClocks project, available on github ([https://github.com/MrBunsy/3DPrintedClocks](github.com/MrBunsy/3DPrintedClocks)) under the Cern Open Hardware Licence. The instructions list the tested generic steps to print and assemble all the components of the clock, but sometimes specific clocks require tweaks and tips which can't be easily captured by the automatic generation system. The advice for this specific clock is as follows:
"""
