...
class TextSpace:
    def __init__(self, x, y, width, height, horizontal, inverted=True, text=None, thick=LAYER_THICK):
        self.x = x
        self.y = y
        self.width = width
        self.height = height
    ...
    def get_text_shape(self):
        ...
        '''
        shape = cq.Workplane("XY").text(self.text, self.text_size, self.thick, kind="bold")
