...
class AutoWallClock:
    ...
    def gen_clock(self):
        ...
        self.train = GoingTrain(pendulum_period=self.pendulum_period_s, fourth_wheel=False, escapement=self.escapement, max_weight_drop=self.weight_drop,
                                use_pulley=True, chain_at_back=False, chain_wheels=1, hours=self.hours, huygens_maintaining_power=self.huygens)
        ...
        self.train.gen_cord_wheels(ratchetThick=4, rodMetricThread=4, cordThick=1, cordCoilThick=14, style=self.gear_style, useKey=True, preferedDiameter=25, looseOnRod=False, prefer_small=True)
