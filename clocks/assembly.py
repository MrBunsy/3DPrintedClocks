...
class Assembly:
    ...
    def get_BOM(self):
        ...
        assembly_instructions = f"""These instructions are autogenerated by the 3DPrintedClocks project, available on github ([https://github.com/MrBunsy/3DPrintedClocks](github.com/MrBunsy/3DPrintedClocks)) under the Cern Open Hardware Licence. The instructions list the tested generic steps to print and assemble all the individual components of the clock, with the final assembly instructions at the end.
{specific_bits}
        """
...
"""
        ...
        for i, arbor in enumerate(self.plates.arbors_for_plate):
            ...
            if i == self.going_train.powered_wheels:
                ...
                arbor_bom.add_subcomponent(clutch_bom)
