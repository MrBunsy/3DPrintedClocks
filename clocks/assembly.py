...
class Assembly:
    ...
    def __init__(self, plates, hands=None, time_mins=10, time_hours=10, time_seconds=0, pulley=None, weights=None, pretty_bob=None, pendulum=None, with_mat=False, name="clock", specific_instructions=None,
                 key_angle_deg = 0, cosmetics=None):
        self.plates = plates
        self.hands = hands
    ...
    def get_BOM(self):
        ...
        dirty = ""
        commit_hash="(git-python not installed)"
        if has_git_python:
            repo = git.Repo(search_parent_directories=True)
            commit_hash = repo.head.commit.hexsha
            dirty = ""
            # if repo.head.commit.is_dirty():
            #     dirty = " (with uncommited changes)"
        # get name of script which triggered this
        filename = os.path.basename(sys.argv[0])
        assembly_instructions = f"""These instructions are autogenerated by the 3DPrintedClocks project, available on github ([https://github.com/MrBunsy/3DPrintedClocks](github.com/MrBunsy/3DPrintedClocks)) under the Cern Open Hardware Licence. This clock was generated by {filename}, commit {commit_hash}{dirty}. The instructions list the tested generic steps to print and assemble all the individual components of the clock, with the final assembly instructions at the end. As these instructions are autogenerated the renderings will reflect this specific clock, but the photos may only be representative.      
...
"""
        ...
        for cosmetic in self.cosmetics:
            bom.add_subcomponent(cosmetic.get_BOM())
