...
motionWorks = clock.MotionWorks(extra_height=15, style=gearStyle, thick=3, compensate_loose_arbor=False, compact=True, reduced_jamming=True,
...
plates = clock.SimpleClockPlates(train, motionWorks, plate_thick=9, back_plate_thick=10, pendulum_sticks_out=pendulumSticksOut, name="Wall 24", gear_train_layout=clock.GearTrainLayout.VERTICAL_COMPACT,
...
assembly.show_clock(show_object, motion_works_colours=[clock.Colour.BRASS], bob_colours=[clock.Colour.PURPLE, clock.Colour.RED, clock.Colour.RED], plate_colours=clock.Colour.LIGHTGREY,
