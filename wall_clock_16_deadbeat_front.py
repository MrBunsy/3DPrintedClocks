...
train.gen_gears(module_size=1, module_reduction=0.875, thick=3, powered_wheel_thick=4, style=gearStyle, pinion_thick_multiplier=2, powered_wheel_pinion_thick_multiplier=2, escapement_split=True)
