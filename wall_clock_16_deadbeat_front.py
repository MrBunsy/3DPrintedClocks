...
plates = clock.SimpleClockPlates(train, motionWorks, pendulum, plateThick=6, pendulumSticksOut=pendulumSticksOut, name="wall clock 16",style=clock.ClockPlateStyle.VERTICAL, pendulumAtFront=False,
