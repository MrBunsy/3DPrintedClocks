...
lift =3
lock=1.5
escapement = clock.AnchorEscapement(drop=drop, lift=lift, teeth=40, lock=lock, tooth_tip_angle=5, tooth_base_angle=4, force_diameter=True, diameter=100)
...
train.gen_gears(module_size=1, module_reduction=0.875, thick=3, powered_wheel_thick=4, style=gearStyle, pinion_thick_multiplier=2, powered_wheel_pinion_thick_multiplier=2, escapement_split=clock.SplitArborType.WHEEL_OUT_FRONT)
...
plates = clock.SimpleClockPlates(train, motionWorks, plate_thick=6, pendulum_sticks_out=pendulumSticksOut, name="wall clock 16", gear_train_layout=clock.GearTrainLayout.VERTICAL, pendulum_at_front=False,
